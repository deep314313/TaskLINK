...
import { FaBath, FaBed, FaCamera, FaCheck, FaTimes } from "react-icons/fa"
                ...
                <div className="p-4">
                    ...
                    >
                        ...
                        <div className='mt-3 flex items-end justify-start'>
                            ...
                            <p className='text-slate-700 w-1/2 font-content font-semibold text-sm flex items-center '><span className='font-heading font-bold mr-1'>{bed}</span> No. of Years</p>



                            <p className='text-slate-700 w-1/2 font-content font-semibold text-sm flex items-center '><span className='font-heading font-bold mr-1'>{bath}</span> Pincode</p>
                        </div>
                        <div className='mt-2 flex items-end justify-start'>
                            <p className='text-slate-700 w-1/2 font-content font-semibold text-sm flex items-center '><FaCheck className={` mr-1 mt-[2px] ${parking ? 'text-green-600' : "text-gray-400"}`} />Smoking</p>

                            <p className='text-slate-700 w-1/2 font-content font-semibold text-sm flex items-center '><FaCheck className={`mr-1 mt-[2px] ${furnished ? 'text-green-600' : "text-gray-400"}`} />Drinking</p>
                        </div>
                        ...
                        <div className="mt-3 flex items-end justify-between">
                            ...
                            <div className="inline-flex rounded-xl max-w-[150px]  duration-500">
                                <p className='font-heading text-lg truncate'>{postInfo.post.area ? postInfo.post.area : 0} <span className='font-content'>/yrs</span> </p>
                            </div>
                        </div>
                    </div>
