        ...
        <div className="listing_card bg-white shadow-lg shadow-black/10  hover:shadow-brand-blue/20 rounded-sm w-full hover:shadow-lg group sm:mr-auto sm:ml-0 mx-auto">
            <div className="card-container">
                ...
                >
                    ...
                    />
                    <div className="absolute bottom-2 left-2 bg-black py-1 px-2 ">
                ...
                <div className="card_body group-hover:bg-brand-blue/5 duration-500  border-x border-b border-brand-blue/20 ">
                    ...
                    >
                        ...
                        <p
                            ...
                            <FaLocationArrow className='mr-1 text-black' />
                            {address}
                        </p>
                        ...
                        <div className="info_container mt-4 flex items-center truncate">
                            ...
                            <p
                                className='font-content text-xs font-bold truncate flex items-center justify-start ml-4'>
                                <FaChartArea className='mr-1 text-black' />
                                {area} Exp.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="listing_footer grid grid-cols-2 align-middle border-t border-black/40 mt-5 p-3 pb-4">

                        <div className="price_container truncate">
                            {offer ?
                                <p className='text-xl font-content text-black font-bold  flex items-center justify-start truncate'>₹{discountPrice} <s className='text-gray-400  text-xs mt-1 ml-1'>${price}</s> </p>

                                : <p className='text-xl font-content text-black font-bold  flex items-center justify-start truncate'>₹{price}</p>
                            }
                        </div>
                        <div className="footer_btn flex items-center justify-end mr-1">
                            <button
                                onClick={() => handleSaveListings(_id)}
                                className={`text-lg drop-shadow-sm duration-300  ${heart ? 'text-black' : "text-gray-300"} `}>
