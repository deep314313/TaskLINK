        ...
        <>
            {
                loading
                    ...
                    <>
                        <Loading />
                        <p className='text-black text-center font-heading text-xl'>Loading your post…</p>
                    </>
                    :
                    <div className="listing_section pb-16 bg-white ">
                        <Slider {...settings} className="z-10 relative">
                            {
                                listings.imgUrl && listings.imgUrl.map((listing, index) => (
                                    <div
                                        key={index}
                                        className="relative w-full h-[300px] sm:h-[550px] mx-auto z-10" // Adjust height as needed
                                    >
                                        <img
                                            className="object-contain w-full h-full rounded-lg shadow-lg" // Updated from 'object-cover'
                                            src={listing}
                                            alt={`Listing ${index + 1}`}
                                        />
                                    </div>
                            ...
                            <div className="property_details_container pt-4 sm:pt-12 ">
                                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                                    ...
                                    <div className="lg:col-span-7  ">
                                        <div className='bg-white md:p-12 p-6 rounded-md shadow-sm shadow-black'>
                                            <div className="property_info">
                                                <p className='font-heading text-black'>
                                                    <span className='py-2 px-6 bg-black/40 rounded-full border border-black uppercase'>
                                                        {type}
                                                    </span>
                                                </p>
                                                ...
                                                {
                                                    offer ?
                                                        <p className='text-2xl font-heading text-black mt-5  text-bold'>
                                                            ₹{discountPrice} <span>
                                                                <s className='text-gray-400 text-sm'>₹{price}</s>
                                                            </span>
                                                        </p>
                                                        :
                                                        <p className='text-2xl font-heading text-black mt-3  text-bold'>
                                                            ₹{price}
                                                        </p>
                                                }
                                            </div>
                                            ...
                                            <div className="property_genarel_info grid-cols-3 grid max-w-md">
                                                <p className='font-heading mt-3 font-medium sm:text-lg  text-sm flex items-center justify-left'>
                                                    ...
                                                    <span className='ml-1'>{bed} Working Hours</span>
                                                </p>
                                                <p className='font-heading mt-3 font-medium sm:text-lg  text-sm flex items-center justify-left'>
                                                    <FaBath className='text-black' />
                                                    <span className='ml-1'>{bath} Pincode</span>
                                                </p>
                                                <p className='font-heading mt-3 font-medium sm:text-lg text-sm flex items-center justify-left'><BiSolidArea className='text-black' />
                                                    <span className='ml-1'>{area} Yrs of Experience</span>
                                                </p>
                                            </div>
                                        ...
                                        <div className="property_details mt-8 bg-white rounded-md shadow-sm shadow-black md:px-12 py-5 px-6">
                                            <div
                                            ...
                                            >
                                                <p className='font-heading text-lg sm:text-xl font-extrabold'>Detail & Features</p>
                                                {
                                                    isFeatureActive
                                                        ?
                                                        <i className='p-[5px] rounded-full bg-black/20 flex items-center justify-center'>
                                                            <FaAngleUp className='text-xl text-black' />
                                                        </i>
                                                        :
                                                        <i className='p-[5px] rounded-full bg-black/20 flex items-center justify-center'>
                                                        ...
                                                        <div className="grid grid-cols-1 sm:grid-cols-2 sm:gap-5 gap-2 ">
                                                            <div className="btn_container">
                                                                <button
                                                                    ...
                                                                    className='bg-black hover:bg-black/90 text-white w-full px-2 py-3 text-lg font-heading rounded-sm'>
                                                                    Update Post
                                                                </button>
                                                            </div>
