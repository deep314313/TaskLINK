                                    ...
                                    <div className="feilds_cotainer mt-4">
                                        <div className="feilds max-w-xs">
                                            ...
                                            <div className="control flex flex-row md:flex-col items-center md:items-start xl:flex-row xl:items-center justify-between mt-1">
                                                <div>
                                                    <label className="flex items-center justify-start text-lg font-heading">
                                                        ...
                                                        <input
                                                            className="radio w-4 h-4 mr-1 bg-transparent border border-solid border-gray-400 rounded-full checked:bg-black checked:border-black dark:checked:bg-white dark:checked:border-black"
                                                            type="radio"
                                                            name="type"
                                                            value="all"
                                                            onChange={(e) => handleChange(e.target.name, e.target.value)}
                                            ...
                                            <div className="aminities_container mt-4">
                                                {/* //<p className='text-lg font-heading'>Advanced</p> */}
                                                <div className="control flex flex-row md:flex-col items-center md:items-start xl:flex-row xl:items-center justify-start mt-1">
                                                    {/* <div className='mr-5'>
                                                        <label className="flex items-center justify-start text-lg font-heading">
                                                            <input
                                                                className="checkbox w-[18px] h-[18px] mr-1 border-gray-400 rounded-md checked:bg-black"
                                                                type="checkbox"
                                                                name="parking"
                                        ...
                                        <div className="btn_cotainer w-full">
                                            <button
                                                className='w-full mt-4 py-2 px-2 bg-black text-white rounded-sm hover:bg-black'
                                    ...
                                    <div>
                                        {
                                            listings.length !== 0 ?
                                                ...
                                                <div className=" mt-40 flex items-center justify-center flex-col">
                                                    ...
                                                    <p className='font-heading text-lg text-center text-black '>Sorry, Listings not found</p>
                                                </div>
