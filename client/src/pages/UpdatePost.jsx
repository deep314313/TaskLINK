        ...
        <main>
            {
                dataLoading
                    ...
                    <div>
                        <Loading />
                        <p className='font-heading text-black text-lg sm:text-2xl text-center'>Loading...</p>
                    </div>
                    :
                    <section>
                                        ...
                                        <div className="info_container">
                                            <div className="input_feilds">
                                                ...
                                                <input
                                                    id='title'
                                                    type="text"
                                                    placeholder='Property name' name='title' className='form_input border-[1px]  focus:border-black rounded-md placeholder:text-sm '
                                                    min={10}
                                                    max={50}
                                                ...
                                                <textarea
                                                    ...
                                                    name='description'
                                                    className='form_input border-[1px]  focus:border-black rounded-md placeholder:text-sm mt-3'
                                                    ...
                                                    <div className="form-control mt-2">
                                                        <label className="label cursor-pointer flex items-center justify-start gap-2">
                                                            <input
                                                                ...
                                                                required
                                                                value='sale'
                                                                className="radio w-5 h-5 bg-transparent border border-solid border-gray-400  checked:bg-black checked:border-black dark:checked:bg-white dark:checked:border-black"
                                                                {...register('type')}
                                                ...
                                                <div className="property_info mt-3">
                                                    ...
                                                    <div className="max-w-[200px] flex items-center justify-between gap-2 mt-2">
                                                        ...
                                                        <div>
                                                            <input
                                                                //defaultValue={550}
                                                                className='border-2 focus:border-black rounded-md max-w-[84px] min-w-[84px] py-1 px-2 bg-transparent'
                                                                type="number"
                                                                name="area"
                                                                id="area"
