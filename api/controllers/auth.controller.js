...
export const signin = async (req, res, next) => {
  ...
  try {
    ...
    const tooken = jwt.sign({ id: validUser._id }, "9f8c2b1d5e69fc5e6aa24b8efc2d5a4b349e5d7d1a7e5f42c8c3e9a5f1c4b2d8", {
      expiresIn: "720h",
    });
    res
...
export const googleSignIn = async (req, res, next) => {
  ...
  try {
    ...
    //====IF user exist in DB====//
    if (user) {
      const tooken = jwt.sign({ id: user._id }, "9f8c2b1d5e69fc5e6aa24b8efc2d5a4b349e5d7d1a7e5f42c8c3e9a5f1c4b2d8", {
        expiresIn: "720h",
      });
